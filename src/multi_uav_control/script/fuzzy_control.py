...
d_R = ctrl.Antecedent(np.arange(0,8, 0.1), 'd_R')
d_R['N'] = fuzz.zmf(d_R.universe, 1.2, 8)
d_R['F'] = fuzz.smf(d_R.universe, 1.2, 8)

d_F = ctrl.Antecedent(np.arange(0,8, 0.1), 'd_F')
