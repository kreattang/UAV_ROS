...
message(STATUS "ros_learning: 0 messages, 2 services")
...
get_filename_component(_filename "/home/wenbing/Learning_ROS_ws/src/ros_learning/srv/AddTwoints.srv" NAME_WE)
add_custom_target(_ros_learning_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ros_learning" "/home/wenbing/Learning_ROS_ws/src/ros_learning/srv/AddTwoints.srv" ""
)

get_filename_component(_filename "/home/wenbing/Learning_ROS_ws/src/ros_learning/srv/WordCount.srv" NAME_WE)
add_custom_target(_ros_learning_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ros_learning" "/home/wenbing/Learning_ROS_ws/src/ros_learning/srv/WordCount.srv" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ros_learning)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ros_learning\")")
  # install generated code
  install(
